\begin{tikzpicture}
  \begin{axis}[
    ...
    \node[color=defcolor, anchor=west, font=\small] at (axis cs:0.15,5.6) {secant ($h=0.9$)};
    \node[color=excolor, anchor=west, font=\small] at (axis cs:0.15,5.0) {secant ($h=0.3$)};
    \node[anchor=west, font=\small] at (axis cs:0.15,4.4) {tangent};
  \end{axis}
\end{tikzpicture}
