\begin{tikzpicture}
  \begin{axis}[
    ...
    \node[color=excolor, anchor=west] at (axis cs:1.55,1.15) {lower sum (left endpoints)};
    \node[color=defcolor, anchor=west] at (axis cs:1.55,2.85) {upper sum (right endpoints)};
  \end{axis}
\end{tikzpicture}
